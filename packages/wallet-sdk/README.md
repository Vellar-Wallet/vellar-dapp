...
```sh
npm install @vela/wallet-sdk @stellar/stellar-sdk
```
...
import { createVellarWallet } from "@vela/wallet-sdk";
...
(`@vela/wallet-sdk/balances`), and RPC-backed readers (`@vela/wallet-sdk/rpc`,
